...
game_over_serface = pygame. transform.scale2x(pygame.image.load('Flappy/assets/message.png'). convert_alpha())
game_over_rect = game_over_serface.get_rect(center = (288, 512))
